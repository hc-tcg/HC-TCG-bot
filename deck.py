...
cards={
   ...
   "tangotek_common":11,
   "ethoslab_rare":10,
   "tinfoilchef_common":10,
   "impulsesv_rare":10,
   "ethoslab_ultra_rare":9,
   "chest":8,
   "netherite_armor":8,
   "fishing_rod":8,
   "iron_armor":8,
   ...
   "lead":7,
   "composter":7,
   "pearlescentmoon_rare":7,
   "curse_of_vanishing":7,
   "chorus_fruit":7,
   "tinfoilchef_ultra_rare":6,
   "diamond_armor":6,
   "geminitay_rare":6,
   "joehills_rare":6,
   "zombiecleo_rare":6,
   "item_explorer_rare":5,
   "item_balanced_rare":5,
   "item_builder_rare":5,
   "item_pvp_rare":5,
   "item_farm_rare":5,
   "item_terraform_rare":5,
   "item_speedrunner_rare":5,
   "mumbojumbo_common":5,
   "item_redstone_rare":5,
   "item_miner_rare":5,
   "item_prankster_rare":5,
   "docm77_rare":5,
   "xisumavoid_common":5,
   "cubfan135_rare":4,
   "welsknight_rare":4,
   "falsesymmetry_rare":4,
   "ijevin_rare":4,
   "netherite_sword":4,
   "instant_health_ii":3,
   "goodtimeswithscar_common":3,
   "golden_axe":2,
   "splash_potion_of_poison":2,
   "instant_health":2,
   "lava_bucket":2,
   "tangotek_rare":2,
   "splash_potion_of_healing":1,
   "keralis_rare":1,
   "iskall85_rare":1,
   "welsknight_common":1,
   "geminitay_common":1,
